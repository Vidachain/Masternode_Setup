...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='vida.conf'
CONFIGFOLDER='/root/.vida'
COIN_DAEMON='vidad'
COIN_CLI='vida-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/Vidachain/Vida-Project/releases/download/v1.0.0/Vida-Linux-Daemon.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='vidad'
COIN_EXPLORER='http://explorer.vidacoin.org'
COIN_PORT=20406
RPC_PORT=20405
